...
;;;
;;; A `pure' concept (it has no title). When processed in a docstring
;;; by MARKDOWN-TO-TEXINFO, it is removed. It's only effect is that
;;; Texinfo @cindex lines are emitted for its keys. It is thus _not_
...
;;; Use this in the normal flow of text like section names. Note other
;;; concepts can be referenced in keys. The definition below is the
;;; titled synonym of ~REPL.
;;;
